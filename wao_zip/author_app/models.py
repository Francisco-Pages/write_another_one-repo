...
class UserExtra(models.Model):
    ...
    cover_image = models.ImageField(upload_to="author_images", default='author_images/profile-default.jpg')
    stories = models.ManyToManyField(story_models.Story, blank=True)
    lists = models.ManyToManyField(story_models.StoryList, related_name='created_lists', blank=True)
    pinned_lists = models.ManyToManyField(story_models.StoryList, related_name='pinned_lists', blank=True)
